...
<div class="main">
  ...
  <div class="drop-zone" id="dropZone">
    ...
    <div class="drop-title" id="dropTitle">Drop your requirements PDF here</div>
    <div class="drop-sub" id="dropSub">or click to browse &nbsp;·&nbsp; PDF files only</div>
  </div>
...
<script>
  ...
  function clearFile() {
    ...
    document.getElementById('dropIcon').textContent = '📋';
    document.getElementById('dropTitle').textContent = 'Drop your requirements PDF here';
    document.getElementById('dropSub').textContent = 'or click to browse · PDF files only';
