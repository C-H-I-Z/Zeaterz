...
Rallis-Daw Consulting | SOTA Tool
------------------------------------------------------
...
<title>SOTA &mdash; Rallis-Daw Consulting</title>
...
<div class="page">
  ...
  <header>
    ...
    <div class="header-right">
      ...
      <div class="tool-label">SOTA &mdash; Prototype v0.1</div>
    </div>
  </header>
  ...
  <div class="content">
    ...
    <section id="helpScreen" class="screen">
      ...
      <div class="page-title">User Support</div>
      <div class="page-heading">Help Center</div>
      <div class="page-sub">Use these FAQ(s) to understand how SOTA supports requirements management for medical device professionals. If your question is not answered here, please contact the team for assistance.
</div>
      ...
      <div class="info-card">
        ...
        <p>SOTA currently accepts PDF, DOCX, and XLSX files.</p>

        <h3>Manual review warnings</h3>
        <p>If a result is marked for manual review, verify it using the official regulatory source before relying on it.</p>

        <h3>Contact</h3>
        <p>91 Avenida Del Mar, Suite 300B San Clemente, CA 92672 USA​<p>  
        <p>info@rallis-dawconsulting.com Tel: +1 (949) 624-4252<p>
        </div>
    ...
    <section id="aboutScreen" class="screen">
      ...
      <div class="page-title">About SOTA</div>
      <div class="page-heading"<br>Regulatory Requirements Management System</div>
      <div class="page-sub">A tool for extracting standards, regulations, and guidance references.</div>

      <div class="info-card">
        <h3>Purpose</h3>
        <p>Our platform assists reviewers by automatically identifying relevant regulatory standards from uploaded 
        device‑requirement documents, improving consistency and reducing manual effort. </p>

        <h3>Intended use</h3>
        <p>This tool is intended to support internal review workflows. It is not a substitute for professional regulatory or compliance judgment.</p>

        <h3>AI disclaimer</h3>
        <p>All AI‑generated outputs must be independently reviewed and validated by a qualified professional before being used in any regulatory, compliance, or submission context. This tool is not designed to process, store, or analyze Protected Health Information (PHI) and should not be used in any workflow requiring HIPAA compliance. Users are responsible for ensuring that no PHI or other sensitive health data is uploaded or included in any inputs.</p>
...
<script>
  function showScreenFromPath() {
    var path = window.location.pathname;
    var screens = ['uploadScreen', 'helpScreen', 'aboutScreen'];
